/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 92d2f170857371e82fccc574dd0a1f08)
...
declare namespace Cloudflare {
	...
	interface Env {
		"0G_MAINNET_RPC_URL": string;
		"0G_TESTNET_RPC_URL": string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "0G_MAINNET_RPC_URL" | "0G_TESTNET_RPC_URL" | "FACILITATOR_PRIVATE_KEY">> {}
}
